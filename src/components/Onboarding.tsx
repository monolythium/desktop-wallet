...
// 24-word BIP-39 recovery phrase, derives the ML-DSA-65 seed with the
        ...
        {step === "choose-path" ? (
          ...
          <>
            ...
            <p style={{ margin: "0 0 18px", color: "var(--w-text-2)", fontSize: 13, lineHeight: 1.55 }}>
              Enter the 24-word recovery phrase that was generated by your
            ...
            <div
              style={{
                ...
                fontSize: 11,
                color:
                  importWordCount === RECOVERY_WORDS
                    ? "var(--ok)"
                    : importWordCount === 0
                      ? "var(--fg-400)"
                      : "var(--warn)",
            ...
            >
              <span>
                {importWordCount} / {RECOVERY_WORDS} words
              </span>
              {importWordCount > 0 && importWordCount !== RECOVERY_WORDS ? (
                <span style={{ color: "var(--fg-400)" }}>
                  {importWordCount < RECOVERY_WORDS ? "keep going…" : "too many"}
                </span>
              ) : null}
            </div>
            {importError && (
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              ...
              <button
                ...
                disabled={importWordCount !== RECOVERY_WORDS}
              >
                Continue
              </button>
            </div>
